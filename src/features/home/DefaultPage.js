        ...
        return (
            <div className="home-default-page">
                ...
                <p>
                    ...
                    This project is initialized with one feature named "home" and two test pages. To remove the test
                    pages, run below commands:
                </p>
                <ul className="cmd">
                ...
                <hr />
                <p>To see how async flow works, here is an example of fetching reactjs topics from
                    reddit.com/r/reactjs:</p>
                <div className="demo-reddit">
                    <button className="btn-fetch-reddit" disabled={fetchRedditReactjsListPending}
                            onClick={this.handleFetchReddit}>
